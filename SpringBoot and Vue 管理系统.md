...
![image-20210912101649454](D:\桌面文件\ty临时图片文件夹\image-20210912101649454.png)

3.   通过上下箭头移动光标，使用空格选择或取消选项。选择如下图个选项：

![image-20210912102335024](D:\桌面文件\ty临时图片文件夹\image-20210912102335024-16314134185741.png)
...
![image-20210912103433643](D:\桌面文件\ty临时图片文件夹\image-20210912103433643-16314140760192.png)
